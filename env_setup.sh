...
then
  ...
  conda create --name dsc pytorch torchvision torchaudio cudatoolkit=10.2 --channel pytorch --channel nvidia
elif [[ $cluster == "tiger" ]]
then
  module load anaconda3
  conda create --name dsc pytorch torchvision torchaudio cudatoolkit=10.2 --channel pytorch --channel nvidia
...
then
	...
	conda create --name dsc pytorch torchvision torchaudio cudatoolkit=11.1 --channel pytorch --channel nvidia
else
