...
partition="gpu"
random_seed="0"
config="../exp_configs/synthetic1/config.yaml"
...
Help()
{
   ...
   echo "Flags:"
   echo -e "${YELLOW}-e${ENDC} | ${YELLOW}--exp_name${ENDC} [default = ${GREEN}\"synthetic1\"${ENDC}] Selected Experiment"
   ...
   echo -e "${YELLOW}-l${ENDC} | ${YELLOW}--config${ENDC} [default = ${GREEN}\"../exp_configs/synthetic1/config.yaml\"${ENDC}] Input directory"
   echo -e "${YELLOW}-o${ENDC} | ${YELLOW}--op_path${ENDC} [default = ${GREEN}\"../logs_dir/synthetic1/\"${ENDC}] Output directory"
   echo -e "${YELLOW}-s${ENDC} | ${YELLOW}--random_seed${ENDC} [default = ${GREEN}\"0\"${ENDC}] Random Seed"
   echo -e "${YELLOW}-d${ENDC} | ${YELLOW}--datapath${ENDC} [default = ${GREEN}\"../datasets/synthetic_data1/\"${ENDC}] Datapath"
